...
| Android · APK de reparto | 1.0 (**461**) publicado en GitHub Releases | sí. **Enlace fijo al último APK**, el que se manda a quien prueba: `https://github.com/inocuosistemas/silosenosalgo/releases/latest/download/SiLoSeNoSalgo.apk`. El compañero sigue con el **271** |
| iOS | 1.0 (**461**) subida a TestFlight el 2026-09-13 | sí, en cuanto salga de *Processing* |
