...
// happens right at startup. Vite fires `vite:preloadError` in that case. Se
// recarga para traerse el build nuevo en vez de enseñar la pantalla de error;
// si ya se han gastado los intentos, que suba al ErrorBoundary.
...
// La casa de un evento —parrilla, mapa, porra, tu plan— es otra pantalla lean:
// no arrastra el planificador entero, igual que el visor.
const EventHub = lazy(() => import('./components/EventHub'))
